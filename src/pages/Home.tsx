              ...
              {browsingHistory.slice(0, 10).map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-primary-600">{item.calories} 卡</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <div className="p-6 md:p-8 bg-white rounded-3xl card-shadow">
              ...
              <h3 className="font-poppins text-xl font-semibold text-gray-800 mb-3">真实数据</h3>
            ...
            <div className="p-6 md:p-8 bg-white rounded-3xl card-shadow">
              ...
              <h3 className="font-poppins text-xl font-semibold text-gray-800 mb-3">直观对比</h3>
              <p className="text-gray-500 leading-relaxed">
            ...
            <div className="p-6 md:p-8 bg-white rounded-3xl card-shadow">
              ...
              <h3 className="font-poppins text-xl font-semibold text-gray-800 mb-3">健康推荐</h3>
              <p className="text-gray-500 leading-relaxed">
